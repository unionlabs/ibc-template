...
//   chainId: sepolia.id,
//   abi: ibcHandlerAbi,
//   address: '0x80ae19d672f3bf5c733e11b7d1a2b880e338165f',
//   functionName: 'capabilities',
//   args: ['f1ba910c57bf8178613a558a8da54e11']
// }).then(console.log)
...
import { snapAddress } from '$/lib/wallet/union'

import { writable, get } from 'svelte/store'
import { fromBech32 } from '@cosmjs/encoding'
import { CONTRACT, UNO } from '$/lib/constants.ts'
import { config, wallet } from '$/lib/wallet/evm.ts'
...
const client = createWalletClient({
  transport: http(),
  chain: sepolia,
  account: privateKeyToAccount('0xedf562d24518d4c92ba6c6630d804b43201305c6cf2eb69213d910838ae79341')
})
export async function pingSepolia(): Promise<Hash> {
  const { request } = await simulateContract(client, {
    account: privateKeyToAccount(
      '0xedf562d24518d4c92ba6c6630d804b43201305c6cf2eb69213d910838ae79341'
    ),
    abi: pingPongAbi,
  ...
  const response = await writeContract(client, request)

  return response
}

// pingSepolia().then(console.log)

// getTransactionReceipt(client, {
//   hash: '0x4a2d4a744cf6ee7c3c52fd557457c6526acb30f7438157934dbda8e8a3760b24'
// }).then(console.log)
