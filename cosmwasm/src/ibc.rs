...
use crate::{msg::PacketData, state::CONFIG, ContractError};
...
pub fn ibc_packet_receive(
    ...
    let ping_packet = PacketData::decode(packet.data)?;
...
fn do_ibc_packet_receive(
    ...
    let ibc_packet = packet.reverse(&config, env.block.time.seconds(), dest_channel_id);
